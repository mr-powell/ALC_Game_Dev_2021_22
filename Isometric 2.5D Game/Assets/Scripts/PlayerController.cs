...
public class PlayerController : MonoBehaviour {
    ...
    void Start()
    {
        ...
        _model = GetComponent<PlayerController>().transform;
    }
    private void Update() {
        GatherInput();
        Look();
    ...
    private void Look()
    {
        ...
        var rot = Quaternion.LookRotation(_input.ToIso(), Vector3.up); // old code
    ...
    private void Move()
    {
        _rb.MovePosition(transform.position + transform.forward * _input.normalized.magnitude * _speed * Time.deltaTime); // old code
